...
Más contexto: [`prompts-AGB.md` §3.27.3](../../prompts-AGB.md#327-capacidad-security-hardening-un-hallazgo-real-un-problema-de-orden-real-y-un-replanteamiento-del-alcance) y [§3.31.1](../../prompts-AGB.md#331-developer-tooling-55-la-última-capacidad-y-un-hallazgo-real-de-tsc-que-ts-node-dev-nunca-había-visto).
