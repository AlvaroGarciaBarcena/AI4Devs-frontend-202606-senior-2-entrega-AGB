...
Más contexto: [`prompts-AGB.md` §3.20](../../prompts-AGB.md#320-code-splitting-del-bundle-code-splitting-agb) (decisión original) y [§3.30.4](../../prompts-AGB.md#330-internationalization-44-accessibility-55-frontend-performance-33-un-fixture-propio-de-test-mal-elegido-un-fallo-de-aislamiento-de-sesión-y-un-hallazgo-real-sin-corregir) (la regresión encontrada).
