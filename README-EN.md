...
├── entrega-frontend-AGB/     Development journal: every branch, prompt and finding from building this project
...
- [`entrega-frontend-AGB/BRANCHES_LOG`](./entrega-frontend-AGB/BRANCHES_LOG) — index of this project's 36 branches, each linked directly to the `prompts-AGB.md` section that documents it.
- [`entrega-frontend-AGB/prompts-AGB.md`](./entrega-frontend-AGB/prompts-AGB.md) — the full development history of this project: every branch, the reasoning behind it, and real bugs found and fixed along the way.
